...
shader {
    ...
    cell {
        fade(1.62…3~1.62) >> shader.cell.fade.on {
        ...
        ave(0…1~0.5) >> shader.cell.ave.on {
        ...
        melt(0…1~0.5) >> shader.cell.melt.on {
            on(%2~0) >> (shader.cell.fade.on(0), shader.cell.ave.on(0), shader.cell.melt.on(0), shader.cell.tunl.on(0), shader.cell.slide.on(0), shader.cell.fred.on(0), shader.cell.zha.on(0))
        }
        tunl(0…5~1) >> shader.cell.tunl.on {
            on(%2~0) >> (shader.cell.fade.on(0), shader.cell.ave.on(0), shader.cell.melt.on(0), shader.cell.tunl.on(0), shader.cell.slide.on(0), shader.cell.fred.on(0), shader.cell.zha.on(0))
        }
        slide(0…7~3) >> shader.cell.slide.on {
            on(%2~0) >> (shader.cell.fade.on(0), shader.cell.ave.on(0), shader.cell.melt.on(0), shader.cell.tunl.on(0), shader.cell.slide.on(0), shader.cell.fred.on(0), shader.cell.zha.on(0))
        }
        fred(0…4~4) >> shader.cell.fred.on {
            on(%2~0) >> (shader.cell.fade.on(0), shader.cell.ave.on(0), shader.cell.melt.on(0), shader.cell.tunl.on(0), shader.cell.slide.on(0), shader.cell.fred.on(0), shader.cell.zha.on(0))
        }
        zha(0…6~2) >> shader.cell.zha.on {
            on(%2~0) >> (shader.cell.fade.on(0), shader.cell.ave.on(0), shader.cell.melt.on(0), shader.cell.tunl.on(0), shader.cell.slide.on(0), shader.cell.fred.on(0), shader.cell.zha.on(0))
            bits(2…4~3)
            loops(11)
        }
...
model {
    canvas {
        ...
        color {
            fade(x 0…1~0.5, y 0…1~0.1) >> (shader.compute.color, sky.color.xfade) ^ sky.main.anim
